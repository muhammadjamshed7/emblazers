...
import FeeLogin from "@/pages/fee/login";
...
import PayrollLogin from "@/pages/payroll/login";
...
import AttendanceLogin from "@/pages/attendance/login";
...
import TimetableLogin from "@/pages/timetable/login";
...
import DateSheetLogin from "@/pages/datesheet/login";
...
import TransportLogin from "@/pages/transport/login";
...
import HostelLogin from "@/pages/hostel/login";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/fee/login" component={FeeLogin} />
      ...
      <Route path="/payroll/login" component={PayrollLogin} />
      ...
      <Route path="/attendance/login" component={AttendanceLogin} />
      ...
      <Route path="/timetable/login" component={TimetableLogin} />
      ...
      <Route path="/datesheet/login" component={DateSheetLogin} />
      ...
      <Route path="/hostel/login" component={HostelLogin} />
